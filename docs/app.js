...
import { MedicalVolumeRenderer, extractSourceThresholdRuns } from './medical-volume.js?v=20260924-build147';
import { unzip } from 'https://esm.sh/fflate@0.8.2';
const APP_VERSION='2026.09.24-147';const APP_BUILD='147';
...
async function start3D(){
 ...
 const collectCutSurfaceSamples=async(screenCurve)=>{
  ...
  for(let i=0;i<probePoints.length;i++){
   ...
   if(surface&&analysisEditTargetMode==='auto'&&!preferred)preferred=surface.key||null;
