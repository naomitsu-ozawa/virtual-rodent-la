...
const I18N={
 ja:{
  ...
  surfaceSmooth:'表面平滑化',strength:'強度',exportStl:'STL書き出し',resetFilters:'画像フィルターをリセット',
 ...
 en:{
  ...
  surfaceSmooth:'Surface Smooth',strength:'Strength',exportStl:'Export STL',resetFilters:'Reset image filters',
