...
function saveProject(){
 ...
 try{
  ...
  downloadBlob(new Blob([bytes],{type:'application/octet-stream'}),base+'_'+new Date().toISOString().slice(0,10)+PROJECT_EXTENSION);
