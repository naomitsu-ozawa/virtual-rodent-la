...
const APP_VERSION='2026.09.23-96';const APP_BUILD='96';
...
function cutPointerVoxel(event,canvas,camera,preferredKey=null){
 ...
 const plane=new THREE.Plane().setFromNormalAndCoplanarPoint(viewDir,camera.position.clone().addScaledVector(viewDir,frontDepth)),world=new THREE.Vector3();
