...
const APP_VERSION='2026.09.24-152';const APP_BUILD='152';
...
function syncMpr3DOverlayPresentation(){
 ...
 for(const key of ['axial','coronal','sagittal']){
  ...
  entry.mesh.material.opacity=volumeMode?.24:.64;
...
function ensureMpr3DPlanes(){
 ...
 for(const [key,def] of Object.entries(defs)){
  ...
  root.visible=!!mpr3DVisibility[key];mesh.visible=!!mpr3DVisibility[key];mesh.material.opacity=threeRenderMode==='volume'?.24:.64;border.visible=!!mpr3DVisibility[key];label.visible=!!mpr3DVisibility[key];
