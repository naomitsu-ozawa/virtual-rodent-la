...
const APP_VERSION='2026.09.24-151';const APP_BUILD='151';
...
function ensureMpr3DPlanes(){
 ...
 for(const [key,def] of Object.entries(defs)){
  ...
  root.visible=!!mpr3DVisibility[key];mesh.visible=!!mpr3DVisibility[key]&&threeRenderMode!=='volume';border.visible=!!mpr3DVisibility[key];label.visible=!!mpr3DVisibility[key];
