...
import { setGpuPrewarmIndex, setGpuPrewarmScheduled, sceneState } from './state.js?v=20260926-build202';
import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.186.0/build/three.webgpu.js';
import { normalizeVrlWgsl, gpuFilterShader, GPU_PREWARM_KINDS } from './gpu-shaders.js?v=20260926-build202';
import { isDesktopMac } from './utils.js?v=20260926-build202';
import { surfaceSmoothingActive, strongSurfaceSmoothingActive } from './settings.js?v=20260926-build202';
import { surfaceSmoothStrength, status } from './ui-shell.js?v=20260926-build202';
