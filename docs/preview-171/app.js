...
import { MedicalVolumeRenderer, extractSourceThresholdRuns } from './medical-volume.js?v=20260925-build171';
import { unzip } from 'https://esm.sh/fflate@0.8.2';
const APP_VERSION='2026.09.25-171';const APP_BUILD='171';
...
const I18N={
 ja:{
  ...
  controls:'3D: 左ドラッグで回転 / Alt+左ドラッグで平面回転 / Shift+左ドラッグ・右ドラッグ・中ドラッグで平行移動 / ホイールでズーム。タッチ: 1本指で回転 / 2本指でズーム・移動・ひねり回転。X/Y/Zで各軸正面へ移動。断面画像: 左右スワイプ / マウスホイールでスライス移動',
 ...
 en:{
  ...
  controls:'3D: left-drag to rotate / Alt+left-drag to roll / Shift+left-drag, right-drag, or middle-drag to pan / wheel to zoom. Touch: one finger rotates; two fingers zoom, pan, and twist-roll. X/Y/Z snap to axis views. MPR: swipe left/right or use the mouse wheel',
...
</div><p class="hint" data-i18n="controls">3D: 左ドラッグで回転 / Alt+左ドラッグで平面回転 / Shift+左ドラッグ・右ドラッグ・中ドラッグで平行移動 / ホイールでズーム。タッチ: 1本指で回転 / 2本指でズーム・移動・ひねり回転。X/Y/Zで各軸正面へ移動。断面画像: 左右スワイプ / マウスホイールでスライス移動</p></section></div></aside>
